namespace Maze_NS;
/// <summary>
/// Represents an abstract item that can be found in the maze that can be picked up by a player and applied for various effects.
/// </summary>
public abstract class Item
{
    ...
    /// <summary>
    /// Creates an object of the <see cref="Item"/> class containing a description, pickup message and value for the effect.
    /// </summary>
