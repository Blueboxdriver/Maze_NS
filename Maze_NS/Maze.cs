namespace Maze_NS
{
    ...
    public class Maze : Tile
    {
        ...
        /// When called, a maze is generated and them populated with <see cref="Item"/>s, <see cref="Monster"/>s, and a <see cref="Player"/>
        ...
        /// Every tile visited by the algorithm is marked as visited and changes the status of <see cref="Tile.IsWall"/> to false.
        /// </summary>
        ...
        /// <summary>
        /// Chooses the bottom right of any generated maze and switches that <see cref="Tile"/>'s <see cref="Tile.IsExit"/> parameter to true.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="Tile"/> the <see cref="Player"/> is currently on <see cref="Tile.IsItem"/>'s status to False.
        /// </summary>
        ...
        /// <summary>
        /// Sets the <see cref="Tile"/> the <see cref="Player"/> is currently on <see cref="Tile.IsMonster"/>'s status to False.
        /// </summary>
        ...
        /// If the method places a monster on a <see cref="Tile"/> where <see cref="Tile.IsWall"/> is already occupied, the method tries again at a different <see cref="Tile"/>.
        /// </summary>
        ...
        private void PlaceMonsters(int amount)
        {
            ...
            while (placedMonsters <= amount)
            {
                ...
                if (!Tiles[y, x].IsWall && !Tiles[y, x].IsExit && !Tiles[y, x].IsPlayer && !Tiles[y, x].IsMonster && !Tiles[y, x].IsItem)
                {
        ...
        /// <summary>
        /// Places a specified amount of monsters into the maze.
        /// If the method places a item on a <see cref="Tile"/> where <see cref="Tile.IsWall"/> is already occupied, the method tries again at a different <see cref="Tile"/>.
        /// </summary>
        /// <param name="amount">The amount of Monsters to be placed</param>
